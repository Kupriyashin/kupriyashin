...
На данный момент времени я являюсь магистром по направлению ["Оптотехника"](https://www.mirea.ru/education/the-institutes-and-faculties/institut-perspektivnykh-tekhnologiy-i-industrialnogo-programmirovaniya/training-programs/magistratura/12-04-02-optical-engineering/). До этого закончил бакалавриат по направлению ["Лазерная техника и лазерные технологии"](https://www.mirea.ru/education/the-institutes-and-faculties/institut-perspektivnykh-tekhnologiy-i-industrialnogo-programmirovaniya/training-programs/bakalavriat/12-03-05-laser-engineering-and-laser-technologies/). При этом параллельно занимался программированием на [Python](https://www.python.org/). Своего рода, я физик с дополнительными навыками обработки данных.
...
<div align="center">
  ...
  |<div align="left">[YouTube Video Downloader **v.2**](https://github.com/Kupriyashin/YouTube-Video_Downloader_v2.git) </div>| Данный проект сочетает в себе следующие фреймворки: **[PyQT5](https://python-scripts.com/pyqt5), [pytube](https://github.com/pytube/pytube)**. Получение информации о видео осуществяется в отдельном потоке, благодаря [QThread](https://doc.qt.io/QT-6/qthread.html).|
  |<div align="left">[YouTube Video Downloader **v.3**](https://github.com/Kupriyashin/Video_YouTube_Downloader_v3.git) </div>|Отошел от загрузки видео по частям - теперь сразу скачивается видео и аудио в одном файле, что увеличило быстроту работы программы и уменьшило количество возникаемых ошибок. Не использовал обработчик ошибок **<i>try: ... except: ... </i>**- теперь все на **<i>if-ах</i>** работает (вроде критических ошибок не наблюдается). Приложение также многопоточно, но теперь вместо 3-х потоков только 2 используются (основной и дополнительный для загрузки видео). Наконец-то разобрался как визуализировать процесс загрузки видео в реальном времени, ввиду чего убрал функцию заглушку визуализации.|
  |<div align="left">[Бот для автоматического поздравления друзей пользователя ВКонтакте](https://github.com/Kupriyashin/Bot-with-auto-healing-of-VKontakte-users.git) </div>|Предназначается для поздравления друзей пользователя Вконтакте. Постоянную работу обеспечивает REPLIT и созданные сервер, на который раз в 5 минут приходят запросы, что позволяет не вырубаться боту. В случе если он все же выключился, все данные хранятся в базе данных.|
...
<div align="center">
  ...
  |<div align="left">[Замена текста на 3 точки, если он больше размеров QLabel **v.2**](https://github.com/Kupriyashin/Replacing-the-last-characters-with-3-characters-when-filling-Label-PyQt5.git)</div>|Более соврешенная версия скрипта по обрезанию текста, в случае если его символьная ширина больше чем QLabel. Скрипт использует для получения размера символа **QFontMetrics** и его метод **elidedText**|
