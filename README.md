...
<div align="center">
  ...
  |<div align="left">[Лабораторная работа по теме: "ИССЛЕДОВАНИЕ ВИДИМОЙ ЧАСТИ ИЗЛУЧЕНИЯ АТОМА ВОДОРОДА И ОПРЕДЕЛЕНИЕ ПОСТОЯННОЙ РИДБЕРГА"](https://github.com/Kupriyashin/DEFINITION-OF-THE-RYDBERG-CONSTANT.git)</div>| Content Cell  |
