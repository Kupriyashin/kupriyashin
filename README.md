...
<div align="center">
  ...
  |<div align="left">[YouTube Video Downloader (проект не закончен, ввиду большого количества багов и недоработок в библиотеке pytube)](https://github.com/Kupriyashin/Downloading-videos-from-YouTube-Pytube-PyQT.git) </div>| Данный проект сочетает в себе следующие фреймворки: **PyQT5, pytube**. Получение информации о видео осуществяется в отдельном потоке, благодаря QThread. Однако ввиду трудности перадачи процесса загрузки видео для визуализации, приложение так и не было закончено.|
